...
use Objects\KarasBundle\Entity\Experience;
use Objects\KarasBundle\Form\ExperienceType;
...
class ExperienceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ObjectsKarasBundle:Experience')->findAll();

        return $this->render('ObjectsKarasBundle:Experience:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ObjectsKarasBundle:Experience:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Experience $entity)
    {
        $form = $this->createForm(new ExperienceType(), $entity, array(
            'action' => $this->generateUrl('employee_experience_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ObjectsKarasBundle:Experience')->find($id);
        ...
        return $this->render('ObjectsKarasBundle:Experience:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ObjectsKarasBundle:Experience:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new ExperienceType(), $entity, array(
            'action' => $this->generateUrl('employee_experience_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('employee_experience'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('employee_experience_delete', array('id' => $id)))
            ->setMethod('DELETE')
