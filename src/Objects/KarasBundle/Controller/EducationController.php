...
use Objects\KarasBundle\Entity\Education;
use Objects\KarasBundle\Form\EducationType;
...
class EducationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ObjectsKarasBundle:Education')->findAll();

        return $this->render('ObjectsKarasBundle:Education:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ObjectsKarasBundle:Education:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Education $entity)
    {
        $form = $this->createForm(new EducationType(), $entity, array(
            'action' => $this->generateUrl('employee_education_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ObjectsKarasBundle:Education')->find($id);
        ...
        return $this->render('ObjectsKarasBundle:Education:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ObjectsKarasBundle:Education:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new EducationType(), $entity, array(
            'action' => $this->generateUrl('employee_education_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('employee_education'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('employee_education_delete', array('id' => $id)))
            ->setMethod('DELETE')
